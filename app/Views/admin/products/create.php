                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="<?= url_to('index.product') ?>">Product</a>
                        </li>
    ...
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <form action="<?= url_to('product-createNew') ?>" enctype="multipart/form-data" method="post">
                    <?= csrf_field() ?>
                    <ul class="nav nav-tabs mb-3" id="custom-tabs-four-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="custom-tabs-four-product-tab"
                               data-toggle="pill" href="#custom-tabs-four-product" role="tab"
                               aria-controls="custom-tabs-four-product" aria-selected="true">Product</a>
                        </li>
                        <li class="nav-item">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="weight"
                                                       value="<?= old('weight') ?>" placeholder="Enter ...">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="weight_type_id">
                                                    ...
                                                    <?php foreach ($weight_types as $weight_type) : ?>
                                                        <option
                                                            value="<?= $weight_type['id'] ?>" <?= ($weight_type['id'] ==
                                                            old('weight_type_id')) ? 'selected' : '' ?>>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="dimension"
                                               value="<?= old('dimension') ?>" placeholder="Enter ...">

                                        <?php if ($validation->hasError('dimension')) : ?>
                                            <span class="text-danger"><?= $validation->getError('dimension') ?></span>
                                        <?php endif ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="price"
                                               value="<?= old('price') ?>" placeholder="Enter ...">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="old_price"
                                               value="<?= old('old_price') ?>" placeholder="Enter ...">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="discount"
                                               value="<?= old('discount') ?>" placeholder="Enter ...">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="discount_type_id">
                                            ...
                                            <?php foreach ($discount_types as $discount_type) : ?>
                                                <option
                                                    value="<?= $discount_type['id'] ?>" <?= ($discount_type['id'] == old('discount_type_id')) ? 'selected' : '' ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2" multiple name="tag_id[]" data-placeholder="Select Tag"
                                            ...
                                            <?php foreach ($tags as $tag) : ?>
                                                <option value="<?= $tag['id'] ?>" <?= ($tag['id'] == old('tag_id'))
                                                    ? 'selected' : '' ?>>
                                                    <?= esc($tag['name']) ?>
                                                </option>
                                            <?php endforeach ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control"
                                            ...
                                            <?php foreach ($categories as $category) : ?>
                                                <option
                                                    value="<?= $category['id'] ?>" <?= ($category['id'] == old('category_id'))
                                                    ? 'selected' : '' ?>>
                                                    <?= esc($category['name']) ?>
                                                </option>
                                            <?php endforeach ?>
                                    ...
                                    <div class="card card-outline card-info">
                                        ...
                                        <div class="card-body">
                                            <textarea id="summernote" name="size_guide"
                                                      placeholder="Enter ..."><?= old('size_guide') ?>
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-outline card-info">
                                        ...
                                        <div class="card-body">
                                            <textarea id="summernote2" name="additional_info"
                                                      placeholder="Enter ..."><?= old('additional_info') ?>
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <table class="table text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control"
                                                ...
                                                foreach ($colors as $color) : ?>
                                                    <option
                                                        value="<?= $color['id'] ?>" <?= ($color['id'] ==
                                                        old('product_color_id'))
                                                        ? 'selected' : '' ?>>
                                                        <?= esc($color['name']) ?>
                                                    </option>
                                                <?php
                                        ...
                                        <td>
                                            <select class="form-control" name="product_size_id[]">
                                                ...
                                                foreach ($sizes as $size) : ?>
                                                    <option
                                                        value="<?= $size['id'] ?>" <?= ($size['id'] == old('product_size_id'))
                                                        ? 'selected' : '' ?>>
                                                        <?= esc($size['name']) ?>
                                                    </option>
                                                <?php
                                        ...
                                        <td>
                                            <button type="button" id="0" class="btn btn-danger deleteRow">
                                                -
                                            </button>
                                        </td>
                                    </tr>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        $('#addRow').click(function() {
          ...
          $('#dynamicadd').
            append('<tr id="row' + i +
              '"><input type="hidden" name="countRow[row<?= $countRow++ ?>]" class="form-control text-center"><td><select class="form-control" name="product_color_id[]"><option></option> <?php foreach ($colors as $color) : ?><option value="<?= $color['id'] ?>" <?= ($color['id'] ==
                  old("product_color_id")) ? 'selected'
                  : '' ?>><?= esc($color['name']) ?></option> <?php endforeach ?></select></td><td><select class="form-control" name="product_size_id[]"><option></option><?php foreach ($sizes as $size) : ?><option value="<?= $size['id'] ?>" <?= ($size['id'] ==
                  old("product_size_id")) ? 'selected'
                  : '' ?>><?= esc($size['name']) ?></option> <?php endforeach ?></select></td><td><input type="text" name="quantity[]" class="form-control text-center"></td><td><input type="text" name="price2[]" class="form-control text-center"></td><td><button type="button" id="' +
