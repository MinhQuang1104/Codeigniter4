    ...
    <div class="login-form-container">
        <h4>Returning customer?
            <button data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"
                    class="btn btn-link btn-toggle">Login
            </button>
        </h4>
    ...
    <div class="checkout-discount">
        <h4>Have a coupon?
            <button data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseOne"
                    class="btn btn-link btn-toggle">ENTER YOUR CODE
            </button>
        </h4>
                    ...
                    <form action="#" id="checkout-form">
                        ...
                        <div class="form-group mb-1">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" data-toggle="collapse" data-target="#collapseThree"
                                       aria-controls="collapseThree" for="create-account">Create an account?</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox mt-0">
                                ...
                                <label class="custom-control-label" data-toggle="collapse" data-target="#collapseFour"
                                       aria-controls="collapseFour" for="different-shipping">Ship to a different
                                                                                             address?</label>
                            </div>
                        </div>
                        ...
                        <div id="collapseFour" class="collapse">
                            <div class="shipping-info">
                                ...
                                <div class="form-group">
                                    <label>Company name (optional)</label>
                                    <input type="text" name="company2" id="company2" class="form-control">
                                </div>
        ...
        <div class="col-lg-5">
            <div class="order-summary">
                ...
                <table class="table table-mini-cart">
                        ...
                        <tr>
                            <td class="product-col">
                                <h3 class="product-title">
                                    ...
                                    <span class="product-qty"><?= $product['product_qty'] ?></span>
                                </h3>
                            </td>
                            ...
                            <div class="form-group form-group-custom-control">
                                <div class="custom-control custom-radio d-flex">
                                    <input type="radio" class="custom-control-input"
                                           name="radio" <?= $cart['shipping_price'] == 0 ? 'checked' : '' ?>>
                    ...
                    <tr id="rowDiscount"
                        style="border-bottom: unset; display: <?= $cart['coupon_price'] == 0 ? 'none' : '' ?>">
                        <td style="font-size: small">Coupon</td>
                        <td id="discount" style="font-size:1.6rem; font-weight:600;">
                            $-<?= $cart['coupon_price'] ?></td>
                    </tr>
                    <tr id="rowFlatRate" style="display: <?= $cart['shipping_price'] == 0 ? 'none' : '' ?>">
                        <td style="font-size: small">Flat Shipping Rate</td>
                        <td id="shipping-price" style="font-size:1.6rem; font-weight:600;">
                            $<?= $cart['shipping_price'] ?></td>
                    </tr>
                    <tr class="order-total">
                        ...
                        <td>
                            <b class="total-price"><span>$<?= $cart['total'] ?></span></b>
                        </td>
                    </tr>
                    </tfoot>
                    <?php endforeach; ?>
                ...
                <button type="submit" id="order" class="btn btn-dark btn-place-order" form="checkout-form">
                    Place order
                </button>
            </div>
            <!-- End .cart-summary -->
